...
public:
    ...
    VectorGeometryPtr parseVisualGeometries(const std::string& robotName, const std::string &environmentFile) const;

    VectorGeometryPtr parseCollisionGeometries(const std::string& robotName, const std::string &environmentFile) const;
