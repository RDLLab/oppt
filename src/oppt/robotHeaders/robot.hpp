...
public:
    ...
    /**
     * @brief Initializes the transition plugin
     *
...
private:
    ...
    bool initializeViewer_(const std::string &robotName, const std::string &environmentFile);

    virtual void setupViewer(const std::string &robotName, const std::string &environmentFile);
